  ...
  head: () => ({
    meta: [
      ...
      { title: "Aria — AI Workplace Productivity Assistant" },
      {
        name: "description",
        content:
          "Automate workplace tasks with AI: emails, meeting summaries, task plans, research briefs and chat.",
      },
      { property: "og:title", content: "Aria — AI Workplace Productivity Assistant" },
      {
        property: "og:description",
        content: "AI workspaces for professionals, with structured prompts and editable outputs.",
      },
